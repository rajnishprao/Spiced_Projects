...
# increasing no. of epochs did not make a difference to the validation loss which is crap - overfitting?
# 8 neurons - and 0.66 accuracy is about as good it is getting without overfitting
# don't think this is a right CNN thing is a right thing to do for this kind a data
# maybe SVC is the way to go - tried this and other ML classifiers but of no avail
# including subjectid and videoid automatically gets accuracy up to 0.97! not surprising
...
x = tensorflow.keras.layers.Dense(64, activation='relu')(inputs)
